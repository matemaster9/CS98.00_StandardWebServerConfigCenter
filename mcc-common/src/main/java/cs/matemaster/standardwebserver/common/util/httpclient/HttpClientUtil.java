...
import cs.matemaster.standardwebserver.common.model.vo.HttpResponseWrapperVO;
...
public class HttpClientUtil {
    ...
    private static HttpResponseWrapperVO doSendGet(String url,
        ...
        try {
            ...
            // http响应成功
            if (BusinessUtil.isTrue(checkHttpRequestSuccess(httpStatus))) {
    ...
    private static HttpResponseWrapperVO doSendPost(String url,
        ...
        if (BusinessUtil.isTrue(needUrlEncode(contentType))) {
